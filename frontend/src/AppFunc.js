...
function App() {
    ...
    //const[varName,index1]=arr,variablevarNameisguaranteedtogetthevalueofindex0 OR "aaa"
    // here is the illustration for this situation
    // below is the return value of useState

    const [favItems, setFavItems] = useState(() => []);

    function handleItemClick(item){// immutability
        ...
        // delete 1 item at index targetInd​// trigger to set a new state​
